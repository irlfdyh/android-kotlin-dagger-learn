...
class RegistrationActivity : AppCompatActivity() {
    ...
    // @Inject annotation at this field means that this field will
    // be provided by [Dagger].
    @Inject
    lateinit var registrationViewModel: RegistrationViewModel

    // Stores an instance of [RegistrationComponent] so that its Fragment
    // can access it
    lateinit var registrationComponent: RegistrationComponent

    override fun onCreate(savedInstanceState: Bundle?) {

        // Creates an instance of Registration component by grabbing the factory
        // from the app graph.
